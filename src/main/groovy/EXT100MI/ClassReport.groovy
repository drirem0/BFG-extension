 ...
 *ABF_R_0102        20220726  RDRIESSEN   Mods BF0100- relace rgdt with trdt for date reporting as rgdt is UTC date      
  ...
  */
  def writeheader() {
    ...
    if (pusl != '99') {
      ...
      EXTCLX.set("EXRGDT", trdt.toInteger());
